...
/**
 * Korean (ko-KR) question pool.
 *
 * Starter: 10 fixed prompts shown in order to new users.
 * Feed: shuffled pool used after starters.
 *
 * Exported as KR_STARTER / KR_FEED / KR_SEED. The locale barrel at
 * data/questions.ts re-exports them under the legacy names for
 * existing callers.
 */
export const KR_STARTER: Question[] = [
  // 1. Snack — 축의금 (현실 갈등형)
  {
...
/** 전체 KR 질문 풀 (starter 고정 + feed 셔플) */
export const KR_SEED: Question[] = [...KR_STARTER, ...KR_FEED];
